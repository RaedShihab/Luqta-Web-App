...
import { MuiThemeProvider, createMuiTheme, Grid, Card, CardContent, CardActionArea, Tabs, Tab, Avatar, useMediaQuery, Container, Icon, ButtonBase, Typography, Badge, Button, Divider, Box,CardMedia } from "@material-ui/core";
                ...
                <Grid item lg={12} md={12} xs={12} style={{ marginBottom: "10px" }}>
                  ...
                  <TabPanel value={adsTab} index={"Details"}>
                    ...
                    <Box className="adBoxWhiteTab" >
                      <div className="adBoxLeftCol">Listing Date:</div> &nbsp;&nbsp; - &nbsp;&nbsp;
                      <div className="adBoxRightCol">01/02/2020</div>
                    </Box>
                    <Box className="adBoxTab" >
                      <div className="adBoxLeftCol">Ad Number:</div> &nbsp;&nbsp; - &nbsp;&nbsp;
                      <div className="adBoxRightCol">ASDF2343432</div>
                    </Box>
                    <Box className="adBoxWhiteTab" >
                      <div className="adBoxLeftCol">Make:</div> &nbsp;&nbsp; - &nbsp;&nbsp;
                      <div className="adBoxRightCol">Alfa Romeo</div>
                    </Box>
                    <Box className="adBoxTab" >
                      <div className="adBoxLeftCol">Series:</div> &nbsp;&nbsp; - &nbsp;&nbsp;
                      <div className="adBoxRightCol">75</div>
                    </Box>
                    <Box className="adBoxWhiteTab" >
                      <div className="adBoxLeftCol">Model:</div> &nbsp;&nbsp; - &nbsp;&nbsp;
                      <div className="adBoxRightCol">2.0 Twin Park</div>
                    </Box>
                    <Box className="adBoxTab" >
